...
export interface BrandGuardianCardProps extends HTMLAttributes<HTMLDivElement> {
  name?: string;
  arabicName?: string;
  status?: string;
  thinking?: string[];
...
export function BrandGuardianCard({ 
  name: nameProp,
  ...
  className, 
  ...props 
}: BrandGuardianCardProps) {
  const t = useTranslations('controlAIBrain.brandGuardian');
