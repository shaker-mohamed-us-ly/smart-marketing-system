...
export interface LearningEngineCardProps extends HTMLAttributes<HTMLDivElement> {
  name?: string;
  arabicName?: string;
  status?: string;
  thinking?: string[];
...
export function LearningEngineCard({ 
  ...
  className, 
  ...props 
}: LearningEngineCardProps) {
  const t = useTranslations('controlAIBrain.learningEngine');
