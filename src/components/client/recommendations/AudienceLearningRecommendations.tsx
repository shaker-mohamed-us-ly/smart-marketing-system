...
import { Users, Heart, Crown, Zap, FileText } from "lucide-react";

export interface AudienceLearningRecommendationsProps extends HTMLAttributes<HTMLDivElement> {
  recommendations?: { 
...
export function AudienceLearningRecommendations({ 
  recommendations: recommendationsProp,
  labels,
  className, 
  ...props 
}: AudienceLearningRecommendationsProps) {
  const t = useTranslations('clientRecommendations.audienceLearning');
